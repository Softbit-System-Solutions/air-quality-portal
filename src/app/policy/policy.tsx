...
const PrivacyPolicy = () => {
  return (
    <div className="max-w-5xl mx-auto px-6 py-12 text-gray-800">
      ...
      <p className="mb-4">
        The County Government may share anonymized environmental data with 
        accredited research institutions, health agencies, and policy partners. 
        No personal user data is sold or shared for commercial use.
      </p>
      ...
      <h2 className="text-xl font-semibold mt-8 mb-2">6. Policy Updates</h2>
      <p className="mb-4">
