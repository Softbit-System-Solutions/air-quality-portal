    ...
    <div className="bg-[#ffffff] min-h-screen">
      ...
      <div className="p-4 sm:p-6">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Bottom Tables */}
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 lg:gap-8 mb-40">
            {/* Cleanest Station */}
            <div>
          ...
          {/* Trends Section */}
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
              <div>
                <h3 className="text-[#101828] font-semibold text-lg mb-1">
                  Air Quality Trends
                </h3>
                <p className="text-[#667085] text-sm">
                  30-day historical data for selected location
                </p>
              </div>
              <div className="relative">
                <button
            ...
            />
          <section className="bg-[#2E7D32] mt-3 text-white h-[50vh] py-16 p-4 w-[100vw] -ml-[8px] sm:-ml-[calc((100vw-100%)/2)]">
            {" "}
